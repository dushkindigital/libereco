...
<hibernate-mapping package="com.libereco.server.model" schema="libereco">
    ...
    <class name="Marketplace" table="marketplace" lazy="false" >
        <!-- <cache usage="read-only"/>  -->    
        <id name="id" column="id" type="java.lang.Long">
            <generator class="native" />
        </id>       
        <property name="marketplaceName" type="java.lang.String" not-null="true"/>
    </class>
    
    <class name="MarketplaceAuthorizations" table="marketplaceAuthorizations" lazy="false" > 
        <!--  
        <id name="id" column="id" type="java.lang.Long">
            <generator class="native" />
        </id> 
        ...
        <property name="token" type="java.lang.String" not-null="false"/>
        <property name="tokenSecret" type="java.lang.String" not-null="false"/>
        <property name="expirationTime" type="java.sql.Timestamp" not-null="false"/>
    </class>
